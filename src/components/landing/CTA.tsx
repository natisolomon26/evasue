...
export default function CTA() {
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-center px-6 md:px-16 py-16 md:py-20 overflow-hidden text-white">
      ...
      {/* --- Overlay Gradient --- */}
      <div className="absolute inset-0 bg-gradient-to-r from-sky-100/50 via-sky-400/50 to-sky-600/90 backdrop-blur-[2px]" />
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl gap-10 md:gap-16">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold leading-tight">
            Walk in <span className="text-sky-900">Faith</span> and{" "}
            <span className="text-sky-900">Community</span>
          </h2>
          ...
          <Link
            href="/about"
            className="group relative overflow-hidden inline-flex items-center justify-center px-8 py-3 mt-2 bg-gradient-to-r from-white/10 to-transparent backdrop-blur-md border border-white/20 text-sky-800 font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105"
          >
