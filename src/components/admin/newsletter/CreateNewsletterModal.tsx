// components/admin/newsletter/CreateNewsletterModal.tsx
"use client";
...
export default function CreateNewsletterModal({ open, setOpen, onCreated }: CreateNewsletterModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ title: "", subject: "", content: "", status: "draft", scheduledFor: "" });
      setOpen(false);
      onCreated();
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Create a new email campaign for your audience</p>
                  </div>
                </div>
                <button
