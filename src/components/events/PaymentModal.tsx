// components/events/PaymentModal.tsx
"use client";
...
export default function PaymentModal({ 
  ...
  const handlePayment = async () => {
    ...
    try {
      // Simulate API call to Chapa
      await new Promise(resolve => setTimeout(resolve, 3000));
      
      // In real implementation, you would:
      // 1. Call your backend to initiate Chapa payment
        ...
        <div className="p-6">
          ...
          {step === 'success' && (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500">
                A confirmation email has been sent to {paymentData.userData.email}
              </p>
            </div>
          )}
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-xl">
            ...
            <div className="space-y-1 text-sm text-gray-600">
              <p><strong>Name:</strong> {paymentData.userData.name}</p>
              <p><strong>Email:</strong> {paymentData.userData.email}</p>
              <p><strong>Phone:</strong> {paymentData.userData.phone}</p>
            </div>
          </div>
